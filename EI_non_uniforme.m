...
%%% paramètres :
Nx = 20; Lx = 3*Ldiff; hx = Lx/(Nx-1); 
Ny = 20; Ly = 3*Ldiff; hy = Ly/(Ny-1); 
Nz = 20; Lz = 3*Ldiff; hz = Lz/(Nz-1); 
N = Nx*Ny*Nz;
Lt = 10e-9; Nt = 50;  dt = Lt/Nt;   %Pas de temps

%%% vecteurs des coordonées: (à changer pour le maillage non uniforme)
...
I = eye(N,N);         %matrice qui multiplie le vecteur b (élément nul pour Nx,Ny,Nz) (devrait être la même que M non ?)
